...
public class Logic {
    ...
    static String winAiText= "Комьютер победил!";
    static String winHText= "Вы победитель!";
    static String winText= "Ничья!";
